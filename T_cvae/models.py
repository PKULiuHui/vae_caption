...
class AttnDecoder(nn.Module):
    ...
    def __init__(self, embed, attention_dim, embed_dim, decoder_dim, latent_size, vocab_size, encoder_dim=2048, dropout=0.5):
        ...
        self.fc_embed = nn.Linear(embed_dim + latent_size, embed_dim)
...
class ImgCapCVAE(nn.Module):
    ...
    def forward(self, imgs, encoded_captions, caption_lengths, val=False):
        ...
        h1 = torch.relu(self.fc1(torch.cat([imgs_mean, caps], dim=-1)))
        ...
        preds, alphas, decode_lengths = self.attnDecoder(imgs, encoded_captions, caption_lengths, z)
    ...
    def generate(self, beam, imgs, BOS, EOS):
        ...
        return self.beam_search(beam, imgs, z, BOS, EOS)
