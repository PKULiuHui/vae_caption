...
save_folder = 'ckpt3/'  # save folder path, for saving different experiment results

# Model parameters
emb_dim = hidden_size = 512  # dimension of word embeddings
...
def main():
    ...
    optimizer = WarmUpOpt(optimizer=torch.optim.Adam(model.parameters(),
                                               lr=lr,
                                               betas=(0.9, 0.99),
                                               eps=1e-9,
                                               weight_decay=0),
